<template>
    <q-dialog transition-show="rotate" transition-hide="rotate">
      <q-card class="q-pa-lg dialog-box">
        <q-form>
          <q-card-section>
            <div class="text-h6"><b>피라미드, 풍경</b></div>
          </q-card-section>
  ...
  const imageFilenames: string[] = [
    ...
    "src/assets/data30/pyramid2.png",
    "src/assets/data30/pyramid3.png",
    "src/assets/data30/pyramid4.png",
    "src/assets/data30/pyramid5.png",
    "src/assets/data30/pyramid6.png",
    "src/assets/data30/pyramid7.png",
    "src/assets/data30/pyramid8.png",
    "src/assets/data30/pyramid9.png",
  ];
