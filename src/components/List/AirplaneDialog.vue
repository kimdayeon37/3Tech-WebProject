<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>비행기에서 바라본 하늘, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  "src/assets/data19/airplane1.png",
  "src/assets/data19/airplane2.png",
  "src/assets/data19/airplane3.png",
  "src/assets/data19/airplane4.png",
  "src/assets/data19/airplane5.png",
  "src/assets/data19/airplane6.png",
  "src/assets/data19/airplane7.png",
  "src/assets/data19/airplane8.png",
  "src/assets/data19/airplane9.png",
];
