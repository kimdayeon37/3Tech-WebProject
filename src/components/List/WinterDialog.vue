<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>겨울, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data2/winter2.png",
  "src/assets/data2/winter3.png",
  "src/assets/data2/winter4.png",
  "src/assets/data2/winter5.png",
  "src/assets/data2/winter6.png",
  "src/assets/data2/winter7.png",
  "src/assets/data2/winter8.png",
  "src/assets/data2/winter9.png",
];
