<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>밤하늘, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data9/nightsky2.png",
  "src/assets/data9/nightsky3.png",
  "src/assets/data9/nightsky4.png",
  "src/assets/data9/nightsky5.png",
  "src/assets/data9/nightsky6.png",
  "src/assets/data9/nightsky7.png",
  "src/assets/data9/nightsky8.png",
  "src/assets/data9/nightsky9.png",
];
