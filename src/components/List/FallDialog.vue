<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>가을, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data1/fall2.png",
  "src/assets/data1/fall3.png",
  "src/assets/data1/fall4.png",
  "src/assets/data1/fall5.png",
  "src/assets/data1/fall6.png",
  "src/assets/data1/fall7.png",
  "src/assets/data1/fall8.png",
  "src/assets/data1/fall9.png",
];
