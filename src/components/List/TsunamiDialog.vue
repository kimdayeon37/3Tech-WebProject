<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>쓰나미, 그림</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data22/tsunami2.png",
  "src/assets/data22/tsunami3.png",
  "src/assets/data22/tsunami4.png",
  "src/assets/data22/tsunami5.png",
  "src/assets/data22/tsunami6.png",
  "src/assets/data22/tsunami7.png",
  "src/assets/data22/tsunami8.png",
  "src/assets/data22/tsunami9.png",
];
