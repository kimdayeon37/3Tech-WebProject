<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>하늘, 그림</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data4/drawing2.png",
  "src/assets/data4/drawing3.png",
  "src/assets/data4/drawing4.png",
  "src/assets/data4/drawing5.png",
  "src/assets/data4/drawing6.png",
  "src/assets/data4/drawing7.png",
  "src/assets/data4/drawing8.png",
  "src/assets/data4/drawing9.png",
];
