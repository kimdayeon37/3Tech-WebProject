<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>유럽 밤거리, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data25/europe2.png",
  "src/assets/data25/europe3.png",
  "src/assets/data25/europe4.png",
  "src/assets/data25/europe5.png",
  "src/assets/data25/europe6.png",
  "src/assets/data25/europe7.png",
  "src/assets/data25/europe8.png",
  "src/assets/data25/europe9.png",
];
