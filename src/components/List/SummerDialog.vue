<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>비오는 날 여름 창문, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data23/summer2.png",
  "src/assets/data23/summer3.png",
  "src/assets/data23/summer4.png",
  "src/assets/data23/summer5.png",
  "src/assets/data23/summer6.png",
  "src/assets/data23/summer7.png",
  "src/assets/data23/summer8.png",
  "src/assets/data23/summer9.png",
];
