<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>블랙홀, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data18/blackhole2.png",
  "src/assets/data18/blackhole3.png",
  "src/assets/data18/blackhole4.png",
  "src/assets/data18/blackhole5.png",
  "src/assets/data18/blackhole6.png",
  "src/assets/data18/blackhole7.png",
  "src/assets/data18/blackhole8.png",
  "src/assets/data18/blackhole9.png",
];
