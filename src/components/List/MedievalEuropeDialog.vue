<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>중세 유럽, 그림</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data26/medievalEurope2.png",
  "src/assets/data26/medievalEurope3.png",
  "src/assets/data26/medievalEurope4.png",
  "src/assets/data26/medievalEurope5.png",
  "src/assets/data26/medievalEurope6.png",
  "src/assets/data26/medievalEurope7.png",
  "src/assets/data26/medievalEurope8.png",
  "src/assets/data26/medievalEurope9.png",
];
