<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>별 가득한 밤하늘, 만화</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data16/nightcartoon2.png",
  "src/assets/data16/nightcartoon3.png",
  "src/assets/data16/nightcartoon4.png",
  "src/assets/data16/nightcartoon5.png",
  "src/assets/data16/nightcartoon6.png",
  "src/assets/data16/nightcartoon7.png",
  "src/assets/data16/nightcartoon8.png",
  "src/assets/data16/nightcartoon9.png",
];
