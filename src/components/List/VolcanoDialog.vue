<template>
    <q-dialog transition-show="rotate" transition-hide="rotate">
      <q-card class="q-pa-lg dialog-box">
        <q-form>
          <q-card-section>
            <div class="text-h6"><b>화산, 풍경</b></div>
          </q-card-section>
  ...
  const imageFilenames: string[] = [
    ...
    "src/assets/data32/volcano2.png",
    "src/assets/data32/volcano3.png",
    "src/assets/data32/volcano4.png",
    "src/assets/data32/volcano5.png",
    "src/assets/data32/volcano6.png",
    "src/assets/data32/volcano7.png",
    "src/assets/data32/volcano8.png",
    "src/assets/data32/volcano9.png",
  ];
