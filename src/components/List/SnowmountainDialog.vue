<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>눈 덮인 산, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  "src/assets/data11/snowmountain1.png",
  "src/assets/data11/snowmountain2.png",
  "src/assets/data11/snowmountain3.png",
  "src/assets/data11/snowmountain4.png",
  "src/assets/data11/snowmountain5.png",
  "src/assets/data11/snowmountain6.png",
  "src/assets/data11/snowmountain7.png",
  "src/assets/data11/snowmountain8.png",
  "src/assets/data11/snowmountain9.png",
];
