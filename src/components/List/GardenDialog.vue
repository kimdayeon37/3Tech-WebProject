<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>꽃 가득한 정원, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data7/garden2.png",
  "src/assets/data7/garden3.png",
  "src/assets/data7/garden4.png",
  "src/assets/data7/garden5.png",
  "src/assets/data7/garden6.png",
  "src/assets/data7/garden7.png",
  "src/assets/data7/garden8.png",
  "src/assets/data7/garden9.png",
];
