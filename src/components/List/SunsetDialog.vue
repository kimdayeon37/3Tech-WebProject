<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>노을 지는 바다, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data8/sunset2.png",
  "src/assets/data8/sunset3.png",
  "src/assets/data8/sunset4.png",
  "src/assets/data8/sunset5.png",
  "src/assets/data8/sunset6.png",
  "src/assets/data8/sunset7.png",
  "src/assets/data8/sunset8.png",
  "src/assets/data8/sunset9.png",
];
