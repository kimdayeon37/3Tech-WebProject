<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>비오는 날 기차, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data5/train2.png",
  "src/assets/data5/train3.png",
  "src/assets/data5/train4.png",
  "src/assets/data5/train5.png",
  "src/assets/data5/train6.png",
  "src/assets/data5/train7.png",
  "src/assets/data5/train8.png",
  "src/assets/data5/train9.png",
];
