<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>미래의 하늘을 나는 버스, 그림</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data17/bus2.png",
  "src/assets/data17/bus3.png",
  "src/assets/data17/bus4.png",
  "src/assets/data17/bus5.png",
  "src/assets/data17/bus6.png",
  "src/assets/data17/bus7.png",
  "src/assets/data17/bus8.png",
  "src/assets/data17/bus9.png",
];
