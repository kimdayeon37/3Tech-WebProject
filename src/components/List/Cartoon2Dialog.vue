<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>미래 자동차, 만화</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data13/cartoon2.png",
  "src/assets/data13/cartoon3.png",
  "src/assets/data13/cartoon4.png",
  "src/assets/data13/cartoon5.png",
  "src/assets/data13/cartoon6.png",
  "src/assets/data13/cartoon7.png",
  "src/assets/data13/cartoon8.png",
  "src/assets/data13/cartoon9.png",
];
