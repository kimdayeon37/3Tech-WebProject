<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>놀이터, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data10/playground2.png",
  "src/assets/data10/playground3.png",
  "src/assets/data10/playground4.png",
  "src/assets/data10/playground5.png",
  "src/assets/data10/playground6.png",
  "src/assets/data10/playground7.png",
  "src/assets/data10/playground8.png",
  "src/assets/data10/playground9.png",
];
