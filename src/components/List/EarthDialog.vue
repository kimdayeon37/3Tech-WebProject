<template>
    <q-dialog transition-show="rotate" transition-hide="rotate">
      <q-card class="q-pa-lg dialog-box">
        <q-form>
          <q-card-section>
            <div class="text-h6"><b>지구, 풍경</b></div>
          </q-card-section>
  ...
  const imageFilenames: string[] = [
    ...
    "src/assets/data27/earth2.png",
    "src/assets/data27/earth3.png",
    "src/assets/data27/earth4.png",
    "src/assets/data27/earth5.png",
    "src/assets/data27/earth6.png",
    "src/assets/data27/earth7.png",
    "src/assets/data27/earth8.png",
    "src/assets/data27/earth9.png",
  ];
