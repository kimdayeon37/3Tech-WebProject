<template>
    <q-dialog transition-show="rotate" transition-hide="rotate">
      <q-card class="q-pa-lg dialog-box">
        <q-form>
          <q-card-section>
            <div class="text-h6"><b>비 내리는 파리, 풍경</b></div>
          </q-card-section>
  ...
  const imageFilenames: string[] = [
    ...
    "src/assets/data29/paris2.png",
    "src/assets/data29/paris3.png",
    "src/assets/data29/paris4.png",
    "src/assets/data29/paris5.png",
    "src/assets/data29/paris6.png",
    "src/assets/data29/paris7.png",
    "src/assets/data29/paris8.png",
    "src/assets/data29/paris9.png",
  ];
