<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>우주 은하계, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data24/universe2.png",
  "src/assets/data24/universe3.png",
  "src/assets/data24/universe4.png",
  "src/assets/data24/universe5.png",
  "src/assets/data24/universe6.png",
  "src/assets/data24/universe7.png",
  "src/assets/data24/universe8.png",
  "src/assets/data24/universe9.png",
];
