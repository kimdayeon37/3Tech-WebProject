<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>스키타는, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data21/ski2.png",
  "src/assets/data21/ski3.png",
  "src/assets/data21/ski4.png",
  "src/assets/data21/ski5.png",
  "src/assets/data21/ski6.png",
  "src/assets/data21/ski7.png",
  "src/assets/data21/ski8.png",
  "src/assets/data21/ski9.png",
];
