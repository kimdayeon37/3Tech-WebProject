<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>비오는 날 바다, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  "src/assets/data14/sea1.png",
  "src/assets/data14/sea2.png",
  "src/assets/data14/sea3.png",
  "src/assets/data14/sea4.png",
  "src/assets/data14/sea5.png",
  "src/assets/data14/sea6.png",
  "src/assets/data14/sea7.png",
  "src/assets/data14/sea8.png",
  "src/assets/data14/sea9.png",
];
