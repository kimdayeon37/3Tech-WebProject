<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>산, 그림</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  ...
  "src/assets/data20/mountain2.png",
  "src/assets/data20/mountain3.png",
  "src/assets/data20/mountain4.png",
  "src/assets/data20/mountain5.png",
  "src/assets/data20/mountain6.png",
  "src/assets/data20/mountain7.png",
  "src/assets/data20/mountain8.png",
  "src/assets/data20/mountain9.png",
];
