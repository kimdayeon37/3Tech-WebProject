<template>
  <q-dialog transition-show="rotate" transition-hide="rotate">
    <q-card class="q-pa-lg dialog-box">
      <q-form>
        <q-card-section>
          <div class="text-h6"><b>별 가득한 밤하늘, 풍경</b></div>
        </q-card-section>
...
const imageFilenames: string[] = [
  "src/assets/data15/nightsky1.png",
  "src/assets/data15/nightsky2.png",
  "src/assets/data15/nightsky3.png",
  "src/assets/data15/nightsky4.png",
  "src/assets/data15/nightsky5.png",
  "src/assets/data15/nightsky6.png",
  "src/assets/data15/nightsky7.png",
  "src/assets/data15/nightsky8.png",
  "src/assets/data15/nightsky9.png",
];
