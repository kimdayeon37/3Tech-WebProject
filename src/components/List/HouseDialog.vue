<template>
    <q-dialog transition-show="rotate" transition-hide="rotate">
      <q-card class="q-pa-lg dialog-box">
        <q-form>
          <q-card-section>
            <div class="text-h6"><b>노을 진 집, 풍경</b></div>
          </q-card-section>
  ...
  const imageFilenames: string[] = [
    "src/assets/data28/house1.png",
    "src/assets/data28/house2.png",
    "src/assets/data28/house3.png",
    "src/assets/data28/house4.png",
    "src/assets/data28/house5.png",
    "src/assets/data28/house6.png",
    "src/assets/data28/house7.png",
    "src/assets/data28/house8.png",
    "src/assets/data28/house9.png",
  ];
