<template>
    <q-dialog transition-show="rotate" transition-hide="rotate">
      <q-card class="q-pa-lg dialog-box">
        <q-form>
          <q-card-section>
            <div class="text-h6"><b>갈대 밭 허수아비, 풍경</b></div>
          </q-card-section>
  ...
  const imageFilenames: string[] = [
    ...
    "src/assets/data31/scarecrow2.png",
    "src/assets/data31/scarecrow3.png",
    "src/assets/data31/scarecrow4.png",
    "src/assets/data31/scarecrow5.png",
    "src/assets/data31/scarecrow6.png",
    "src/assets/data31/scarecrow7.png",
    "src/assets/data31/scarecrow8.png",
    "src/assets/data31/scarecrow9.png",
  ];
